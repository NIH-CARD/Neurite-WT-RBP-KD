...
lst <- list(
            ...
            targeting_nontargeting_N_WT=list(
                sampletable=colData %>% filter(group == 'WT' & zone == 'N'),
                design=~targeting,
                subset_counts=TRUE),

            targeting_nontargeting_S_WT=list(
                sampletable=colData %>% filter(group == 'WT' & zone == 'S'),
                design=~targeting,
                subset_counts=TRUE),

            zone_sg1152_FUSkd=list(
                sampletable=colData %>% filter(roup == 'FUSkd' & guide_group='sg1152'),
                design=~pair + zone,
                subset_counts=TRUE),

            zone_sg100_FUSkd=list(
                sampletable=colData %>% filter(roup == 'FUSkd' & guide_group='sg100'),
                design=~pair + zone,
                subset_counts=TRUE),

            zone_sg100_TDP43kd=list(
                sampletable=colData %>% filter(roup == 'TDP43kd' & guide_group='sg100'),
                design=~pair + zone,
                subset_counts=TRUE),

            zone_sg200_TDP43kd=list(
                sampletable=colData %>% filter(roup == 'TDP43kd' & guide_group='sg200'),
                design=~pair + zone,
                subset_counts=TRUE),

            zone_sg1126_HNRNPA1kd=list(
                sampletable=colData %>% filter(roup == 'HNRNPA1kd' & guide_group='sg1126'),
                design=~pair + zone,
                subset_counts=TRUE),

            zone_sg1128_HNRNPA1kd=list(
                sampletable=colData %>% filter(roup == 'HNRNPA1kd' & guide_group='sg1128'),
                design=~pair + zone,
                subset_counts=TRUE),
...
contr_01afa_lfc0_targeting_nontargeting_N_HNRNPA1kd_fc <- lcdbwf:::make_results(
  dds_name="targeting_nontargeting_N_HNRNPA1kd",
  contrast=c("targeting", "nontargeting", "targeting"),
  #lfcThreshold=1,
  type="ashr",
  label="HNRNPA1-- targeting vs nontargeting lfc >0"
)
```
