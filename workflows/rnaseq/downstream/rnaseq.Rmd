...
for (group in unique(colData$group)){
  if (group != 'WT'){
    ...
    list_name <- paste0(group,"_SN_",guide1,"_",guide1,"_interaction")
...
##HNRP N contrasts
contr_01aa_lfc0_trgt_ntrgt_N_HNRNPA1kd <- lcdbwf:::make_results(
  dds_name="targeting_nontargeting_N_HNRNPA1kd",
  contrast=c("targeting", "targeting", "nontargeting"),
  lfcThreshold=0,
  type="ashr",
  label="HNRNPA1 Neurites -- targeting vs nontargeting lfc >0"
)
```
...
contr_01ba_lfc0_trgt_ntrgt_S_HNRNPA1kd <- lcdbwf:::make_results(
  dds_name="targeting_nontargeting_S_HNRNPA1kd",
  lfcThreshold=0,
  contrast=c("targeting", "targeting", "nontargeting"),
  type="ashr",
  label="HNRNPA1 Soma -- targeting vs nontargeting lfc >0"
)
```
...
contr_02aa_lfc0_trgt_ntrgt_N_FUSkd <- lcdbwf:::make_results(
  # FUS contrasts
  dds_name="targeting_nontargeting_N_FUSkd",
  contrast=c("targeting", "targeting", "nontargeting"),
  lfcThreshold=0,
  type="ashr",
  label="FUS Neurites -- targeting vs nontargeting lfc >0"
)
```
...
contr_02ba_lfc0_trgt_ntrgt_S_FUSkd <- lcdbwf:::make_results(
  dds_name="targeting_nontargeting_S_FUSkd",
  lfcThreshold=0,
  contrast=c("targeting", "targeting", "nontargeting"),
  type="ashr",
  label="FUS Soma -- targeting vs nontargeting lfc >0"
)
```
...
contr_03aa_lfc0_trgt_ntrgt_N_TDP43kd <- lcdbwf:::make_results(
  # TDP43 contrasts
  dds_name="targeting_nontargeting_N_TDP43kd",
  contrast=c("targeting", "targeting", "nontargeting"),
  lfcThreshold=0,
  type="ashr",
  label="TDP43 Neurites -- targeting vs nontargeting lfc >0"
)
```
...
contr_03ba_lfc0_trgt_ntrgt_S_TDP43kd <- lcdbwf:::make_results(
  dds_name="targeting_nontargeting_S_TDP43kd",
  lfcThreshold=0,
  contrast=c("targeting", "targeting", "nontargeting"),
  type="ashr",
  label="TDP43 Soma -- targeting vs nontargeting lfc >0"
)
```
...
contr_11a_zone_sg1126_HNRNPA1kd <- lcdbwf:::make_results(
  ...
  contrast=c('zone', 'N', 'S'),
  type='ashr',
  label='zone_sg1126_HNRNPA1kd lfc > 0'
)
```
...
contr_11b_zone_sg1128_HNRNPA1kd <- lcdbwf:::make_results(
  ...
  contrast=c('zone', 'N', 'S'),
  type='ashr',
  label='zone_sg1128_HNRNPA1kd lfc > 0'
)
```
...
contr_13a_zone_sg100_TDP43kd <- lcdbwf:::make_results(
  ...
  contrast=c('zone', 'N', 'S'),
  type='ashr',
  label='zone_sg100_TDP43kd lfc > 0'
)
```
...
contr_13b_zone_sg200_TDP43kd <- lcdbwf:::make_results(
  ...
  contrast=c('zone', 'N', 'S'),
  type='ashr',
  label='zone_sg200_TDP43kd lfc > 0'
)
```
