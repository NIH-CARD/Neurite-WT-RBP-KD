...
colData$targeting <- factor(colData$targeting, levels=c('non-targeting', 'targeting')
                            )
...
contr_01afa_lfc0_targeting_nontargeting_N_HNRNPA1kd_fc <- lcdbwf:::make_results(
  ...
  contrast=c("targeting", "non-targeting", "targeting"),
  #lfcThreshold=1,
  type="ashr",
...
contr_01afa_lfc1_targeting_nontargeting_N_HNRNPA1kd <- lcdbwf:::make_results(
  dds_name="targeting_nontargeting_N_HNRNPA1kd",
  lfcThreshold=1,
  contrast=c("targeting", "non-targeting", "targeting"),
  type="ashr",
  label="HNRNPA1-- targeting vs nontargeting lfc >1"
)
```

```{r results_02, dependson='dds_list', cache=TRUE, eval=FALSE}
contr_01af_lfc0_targeting_nontargeting_S_HNRNPA1kd <- lcdbwf:::make_results(
...
contr_02af_zone_sg1126_HNRNPA1kd <- lcdbwf:::make_results(
  dds_name="zone_sg1126_HNRNPA1kd",
  contrast=c('full_guide_grp', 'sg1126_S_HNRNPA1kd', 'sg1126_N_HNRNPA1kd'),
  type='ashr',
  label='zone_sg1126_HNRNPA1kd lfc > 0 FeatureC'
)
```
