...
```{r finalclusters, fig.width=12, results='asis', cache=TRUE, dependson='load', cache.lazy=FALSE}
...
```{r combined_rds, cache=TRUE, dependson='finalclusters', cache.lazy=FALSE}
